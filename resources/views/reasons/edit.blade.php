            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="reason" id="reason" value="{{ old('reason', $reason->reason) }}" class=" bg-base-200 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-base-300 rounded-md @error('reason') border-red-500 @enderror">
                        @error('reason')
