    ...
    <div class="p-6 border-b border-base-300">
        <form action="{{ route('types.index') }}" method="GET" class="flex gap-4">
            <div class="flex-1">
                ...
                <input type="text" name="search" id="search" value="{{ request('search') }}" class="bg-base-100 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-base-300 rounded-md" placeholder="Search Type...">
            </div>
