...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="p-6 border-b">
            <h2 class="text-xl font-semibold text-gray-800">Edit Operator</h2>
        </div>
        ...
        <form action="{{ route('operators.update', $operator) }}" method="POST" class="p-6">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="operator" id="operator" value="{{ old('operator', $operator->operator) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('operator') border-red-500 @enderror" required>
                @error('operator')
